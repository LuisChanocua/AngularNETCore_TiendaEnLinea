...
#warning To protect potentially sensitive information in your connection string, you should move it out of source code. You can avoid scaffolding the connection string by using the Name= syntax to read it from configuration - see https://go.microsoft.com/fwlink/?linkid=2131148. For more guidance on storing connection strings, see https://go.microsoft.com/fwlink/?LinkId=723263.
        => optionsBuilder.UseSqlServer("Server=ESTEBANLAPTOPN4; DataBase=CursoAngularNETCoreApi_TiendaEnLinea; Trusted_Connection=True; TrustServerCertificate=True;");

    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        modelBuilder.Entity<Categoria>(entity =>
        {
            entity.HasKey(e => e.IdCategoria).HasName("PK__Categori__8A3D240CAB5B6B77");
        ...
        {
            entity.HasKey(e => e.IdDetalleVenta).HasName("PK__DetalleV__BFE2843F6549E2B0");
        ...
        {
            entity.HasKey(e => e.IdMenu).HasName("PK__Menu__C26AF48323050EF0");
        ...
        {
            entity.HasKey(e => e.IdMenuRol).HasName("PK__MenuRol__9D6D61A4BB6C4242");
        ...
        {
            entity.HasKey(e => e.IdNumeroDocumento).HasName("PK__NumeroDo__471E421A7B0910C0");
        ...
        {
            entity.HasKey(e => e.IdProducto).HasName("PK__Producto__07F4A13206107C72");
        ...
        {
            entity.HasKey(e => e.IdRol).HasName("PK__Rol__3C872F764C781EDB");
        ...
        {
            entity.HasKey(e => e.IdUsuario).HasName("PK__Usuario__645723A637264635");
        ...
        {
            entity.HasKey(e => e.IdVenta).HasName("PK__Venta__077D5614C58F8520");
